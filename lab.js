...
user.username = "bryan.smith@devmounta.in";
...
cat1 = new Cat("shithead", 7, "purple");
...
let Harry = new Wizard("Harry", "25", "abracodabra");
...
phone1 = new Phone("iphone", "7", 7, "white", 100);
phone2 = new Phone("iphone", "7", 12, "black", 150);
phone3 = new Phone("Android", "10", 6, "sage", 200);
...
console.log(phone1.changePrice(235));
...
let myFirstVehicle = new Vehicle(7, "black", 0);
...
let myFirstMotorcycle = new Motorcycle(2, "white", 0, "Honda", "Yes");
...
boat1 = new Boat(10, 'black', 0, 'ol bess', 'speedboat', false )
